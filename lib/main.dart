...
class RowColumnPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bismillah', style: TextStyle(color: Colors.black)),
      ...
      body: Column(
        ...
        children: <Widget>[
          Container(
            child: AspectRatio(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.network(
                    'https://tse1.mm.bing.net/th/id/OIP.z7hczHvzGF5s2S7UYcaruwHaJT?rs=1&pid=ImgDetMain&o=7&rm=3',
                    fit: BoxFit.cover,
                    width: 500,
                  ),
                ),
          ...
          Container(
            ...
            child: Text('HIDUP HIDUP HIDUP', style: TextStyle(fontSize: 16)),
          ),
          Container(
            width: MediaQuery.of(context).size.width,
            padding: EdgeInsets.all(20.0),
